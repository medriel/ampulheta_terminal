...
## Principais desafios e estratégias adotadas: 
  ...
  - Realizei a divisão do desafio em:
   ...
   - Utilizei o método "repeat" para desenvolver as extremidades e a divisória da ampulheta, onde eu definia o caractere que queria usar. E então aplicava nele o método "repeat" de acordo com o valor informado pelo usuário.
